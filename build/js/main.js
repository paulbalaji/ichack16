...
(function($) {
   ...
   // 	$('.js .design .feature-media').addClass( 'animated swing' );    
  	// }, { offset: 'bottom-in-view' });

  	// $('.js .responsive').waypoint(function() {
   // 	$('.js .responsive .feature-media').addClass( 'animated swing' );    
  	// }, { offset: 'bottom-in-view' });

  	// $('.js .cross-browser').waypoint(function() {
   // 	$('.js .cross-browser .feature-media').addClass( 'animated swing' ); 
  	// }, { offset: 'bottom-in-view' });

  	// $('.js .video').waypoint(function() {
   // 	$('.js .video .feature-media').addClass( 'animated swing' );     
  	// }, { offset: 'bottom-in-view' });
